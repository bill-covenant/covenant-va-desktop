      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: 3, child: Padding(padding: const EdgeInsets.only(right: 10), child: _dispositionChip(context, lead, isDark))),
            Expanded(flex: 3, child: Padding(padding: const EdgeInsets.only(right: 10), child: _outcomeChip(context, lead, isDark))),
